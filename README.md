...
A new method for modeling main and interaction effects of continuous input variables in Artificial Neural Networks (ANNs). The method was published in a paper on 20 June 2022 at
